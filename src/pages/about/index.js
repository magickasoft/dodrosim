...
const ancors = [
  {name: 'Деятельность', href: '#activity'},
  {name: 'Руководство', href: '#management'},
  {name: 'Реквизиты', href: '#requisites'},
  {name: 'Противодействие коррупции', href: '#corruption'}
];
...
export default function about() {
  return (
    <>
      ...
      <Page label="Об учреждении" ancors={ancors}>
        <Header id="activity">Деятельность</Header>
        <Activity>
          <Text>
